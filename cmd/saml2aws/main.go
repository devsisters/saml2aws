...
func main() {
	...
	app.Flag("url", "The URL of the AWS SAML IDP server used to login. (env: SAML2AWS_URL)").Envar("SAML2AWS_URL").StringVar(&commonFlags.URL)
	app.Flag("tencentcloud-url", "The URL of the TencentCloud SAML IDP server used to login. (env: SAML2AWS_TENCENTCLOUD_URL)").Envar("SAML2AWS_TENCENTCLOUD_URL").StringVar(&commonFlags.TencentCloudURL)
